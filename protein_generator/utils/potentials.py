...
from protclap_potential import ProtCLAPGuidance, TargetSequenceGuidance
...
POTENTIALS = {'aa_bias':AACompositionalBias, 
              'charge':ChargeBias, 
              'hydrophobic':HydrophobicBias, 
              'PSSM':PSSMbias,
              # ---------------------------
              "protclap":ProtCLAPGuidance,
              "target":TargetSequenceGuidance} # NEW
