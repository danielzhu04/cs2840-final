...
def protein_diffusion_model(sequence, seq_len, helix_bias, strand_bias, loop_bias, 
    ...
    dssp_checkpoint = './checkpoints/SEQDIFF_230205_dssp_hotspots_25mask_EQtasks_mod30.pt'
    og_checkpoint = './checkpoints/SEQDIFF_221219_equalTASKS_nostrSELFCOND_mod30.pt'
